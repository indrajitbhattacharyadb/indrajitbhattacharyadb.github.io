        ...
        n = {
            ...
            var c = (function () {
                ...
                function u(n, t, r, i) {
                  ...
                  return (
                    a &&
                    Object.assign(
                      { activity: n, name: t, component: i[o.JR] },
                      a
                    )
                  );
                }
          ...
          2931: function (e, n, t) {
            ...
            var f = t(3193),
              ...
              k = t(9633),
              O = t(4947),
              E = ["cpm", "ttl", "creativeId", "netRevenue", "currency"],
                      ...
                      S.forEach(function (e) {
                        ...
                        B(e, S.map(g.bidRequest), g.bidderRequest(t), u, d, {
                          onRequest: function (e) {
                            return h.j8(p.FP.BEFORE_BIDDER_HTTP, t, e);
                          },
                            ...
                            if (t) {
                              if (
                                ...
                                return (
                                  ...
                                  void r.reject(t.adUnitCode, n, p.Gw.Dg)
                                );
                              (n.originalCpm = n.cpm),
                      ...
                      t.measureTime("addBidResponse.validate", function () {
                        return (function (e, n) {
                          ...
                          if (
                            ...
                            return (
                              (0, a.H)(
                                o("Banner bids require a width and height")
                              ),
                              !1
                            );
                          return !0;
                        ...
                        ? r(e, n)
                        : r.reject(e, n, p.Gw.UI);
                  }
                  function Z() {
                    o(),
                      f.vc.runWithBidder(e.code, function () {
                        h.j8(p.FP.BIDDER_DONE, t),
            ...
            var B = (0, b.z3)(
                ...
                function (e, n, t, r, i, o) {
                  ...
                  var p = v.measureTime("buildRequests", function () {
                    return e.buildRequests(n, t);
                  });
                  if (p && 0 !== p.length) {
                    Array.isArray(p) || (p = [p]);
                    var h = (0, a.yx)(g, p.length);
                      ...
                      switch (n.method) {
                        case "GET":
                          r(
                            ...
                            { success: g, error: p },
                            void 0,
                            b({ method: "GET", withCredentials: !0 })
                          );
                          break;
                        case "POST":
                          r(
              ...
              U = (0, b.z3)("sync", function (e, n) {}, "addComponentAuction");
            function R(e, n) {
              var t =
                  arguments.length > 2 && void 0 !== arguments[2]
                    ? arguments[2]
              ...
              if (1 === d.length) {
                var f = d[0].split("x"),
                  ...
                  v = l[1];
                return (
                  (n.width = parseInt(g, 10)), (n.height = parseInt(v, 10)), !0
                );
              }
              return !1;
            }
            ...
            var ue = {},
              ce = (0, q.Oj)(function (e) {
                return re.resolveAlias(e);
              });
            function se(e) {
              return ce(k.wu, X, (0, o.Z)({}, q.Qf, e.configName));
            }
            var de = (0, b.z3)(
              "sync",
              function (e) {
                          ...
                          return (
                            ...
                            e.push(
                              Object.assign({}, n, {
                                ...
                                src: o,
                                metrics: c,
                                bidRequestsCount: D.f.getRequestsCounter(
                                  i.code
                                ),
                                bidderRequestsCount:
                                  D.f.getBidderRequestsCounter(
                                    i.code,
                                    n.bidder
                                  ),
                                bidderWinsCount: D.f.getBidderWinsCounter(
                                  i.code,
                                  n.bidder
                                ),
                              })
            ...
            function me(e, n, t) {
              if ((null == t ? void 0 : t.src) !== p.os.YZ) {
                var i = ye(e, n);
                null != i && be.apply(void 0, [e, n].concat((0, r.Z)(i), [t]));
              }
            }
            function we(e) {
            ...
            (re.makeBidRequests = (0, b.z3)(
              ...
              function (e, n, t, r, i) {
                ...
                (u = (0, C.Bf)(u)),
                  h.j8(p.FP.BEFORE_REQUEST_BIDS, e),
                  (0, c.Fb)(e),
                  e.forEach(function (e) {
                    (0, a.PO)(e.mediaTypes) || (e.mediaTypes = {}),
                      (e.bids = e.bids.filter(function (e) {
                        return (
                          !e.bidder || te.isAllowed(O.UE, ce(k.UL, e.bidder))
                        );
                      }));
                  }),
                  (e = ve(e, i));
                ...
                var g = (0, Z.nH)(),
                  ...
                  m = o.bidder || {};
                function w(e, n) {
                  var r = te.redact(null != n ? n : ce(k.UL, e.bidderCode)),
                    i = Object.freeze(
                      r.ortb2(
                        (0, a.Ee)({ source: { tid: t } }, b, m[e.bidderCode])
                      )
                    );
                  return (
                    (e.ortb2 = i),
                ...
                ae.forEach(function (r) {
                  ...
                  if (r && r.enabled && te.isAllowed(O.UE, i)) {
                    ...
                    (0 === l.length && s ? [null] : l).forEach(function (e) {
                      ...
                      0 !== f.bids.length && v.push(f);
                    }),
                      c.forEach(function (e) {
                        var n = e.bids.filter(function (e) {
                          return (0, y.sE)(v, function (n) {
                            return (0, y.sE)(n.bids, function (n) {
                ...
                return (
                  d.forEach(function (e) {
                    ...
                    d ||
                      ...
                      d && s.bids && 0 !== s.bids.length && v.push(s);
                  }),
                  v.forEach(function (e) {
                    N.rp.getConsentData() &&
                      (e.gdprConsent = N.rp.getConsentData()),
                      N.nX.getConsentData() &&
              ...
              (re.callBids = function (e, n, t, r, o, u, c) {
                ...
                if (n.length) {
                  var d = n.reduce(
                      function (e, n) {
                        return (
                          e[Number(void 0 !== n.src && n.src === p.os.YZ)].push(
                            n
                          ),
                          e
                        );
                  ...
                  v.forEach(function (e) {
                    for (var n = -1, t = 0; t < y.length; ++t)
                      if (e.uniquePbsTid === y[t].uniquePbsTid) {
                        n = t;
                        break;
                      }
                    n <= -1 && y.push(e);
                  ...
                  ae.forEach(function (e) {
                    if (e && y[b] && pe(e).has(y[b].bidderCode)) {
                      var n = (0, x.OI)(
                          u,
                          o
                            ? {
                      ...
                      if (d) {
                        ...
                        if (m.ad_units.length) {
                          var w = g.map(function (e) {
                            ...
                            C = (0, a.pP)(m.ad_units).filter(function (e) {
                              return i.includes(e);
                            });
                          (0, a.ji)(
                    ...
                    g.forEach(function (e) {
                      ...
                      f.vc.runWithBidder(e.bidderCode, function () {
                        (0, a.ji)("CALLING BIDDER"),
                          h.j8(p.FP.BID_REQUESTED, e);
                      });
                      var i = (0, x.OI)(
                          u,
                          o
                ...
                e && n
                  ? "function" == typeof e.callBids
                    ? ((ie[n] = e),
                      ...
                      (0, y.q9)(o, "video") && re.videoAdapters.push(n),
                      (0, y.q9)(o, "native") && c.Sg.push(n))
                    : (0, a.H)(
                    ...
                    try {
                      var o,
                        u = (function (e) {
                          var n = [];
                          return (
                            (0, y.q9)(re.videoAdapters, e) && n.push("video"),
                            (0, y.q9)(c.Sg, e) && n.push("native"),
                            n
                          );
                        })(e);
                ...
                (0, a.kJ)(e) || (e = [e]),
                  e.forEach(function (e) {
                    ...
                    n && n.adapter
                      ? te.isAllowed(
                          O.x$,
                          ce(k._U, e.provider, (0, o.Z)({}, q.Hw, e))
              ...
              (re.callBidWonBidder = function (e, n, t) {
                (n.params = (0, a.S0)(t, n.adUnitCode, n.bidder)),
                  D.f.incrementBidderWinsCounter(n.adUnitCode, n.bidder),
                  me(e, "onBidWon", n);
              }),
              (re.callBidBillableBidder = function (e) {
                me(e.bidder, "onBidBillable", e);
              }),
              (re.callSetTargetingBidder = function (e, n) {
                me(e, "onSetTargeting", n);
              }),
              (re.callBidViewableBidder = function (e, n) {
                me(e, "onBidViewable", n);
              }),
              (re.callBidderError = function (e, n, t) {
                me(e, "onBidderError", { error: n, bidderRequest: t });
              }),
              (re.callDataDeletionRequest = (0, b.z3)("sync", function () {
                for (
                ...
                Object.keys(ie)
                  ...
                  .forEach(function (e) {
                    var t = ye(e, o);
                    if (null != t) {
                      var i = m.K.getBidsRequested().filter(function (n) {
                        return we(n.bidderCode) === e;
                      });
                      be.apply(void 0, [e, o].concat((0, r.Z)(t), [i], n));
                    }
                  }),
          ...
          1176: function (e, n, t) {
            ...
            var j = t(8640),
              I = h.k_.syncUsers,
              B = "completed";
            A.on(k.FP.BID_ADJUSTMENT, function (e) {
              !(function (e) {
            ...
            function x(e) {
              ...
              function X(e) {
                if (
                  (e ? A.j8(k.FP.AUCTION_TIMEOUT, Y()) : clearTimeout(v),
                  void 0 === g)
                ) {
                  var t = [];
                  e &&
                    ...
                    (t = L.filter(function (e) {
                      return !x.has(e.bidderRequestId);
                    }).flatMap(function (e) {
                      return e.bids;
                    })).length && A.j8(k.FP.BID_TIMEOUT, t)),
                    (p = B),
                    (g = Date.now()),
                    ...
                    M.resolve(),
                    A.j8(k.FP.AUCTION_END, Y()),
                    q(h, function () {
                      try {
                        if (null != z) {
                          var r = K.filter(function (e) {
                            return m.includes(e.adUnitCode);
                          }).reduce(ee, {});
                          z.apply(P, [r, e, C]), (z = null);
                        }
                      } catch (e) {
                    ...
                    run: function () {
                      ...
                      var r = (function (e, n) {
                        ...
                        function v() {
                          var t = this,
                            a = n.getBidRequests(),
                            s = f.vc.getConfig("auctionOptions");
                          if ((u.add(t), s && !(0, o.xb)(s))) {
                            var d = s.secondaryBidders;
                            d &&
                              !a.every(function (e) {
                                return (0, b.q9)(d, e.bidderCode);
                              }) &&
                          ...
                          (i = a.every(function (e) {
                            ...
                            t.bids.forEach(function (e) {
                              c[e.bidId] ||
                                (n.addNoBid(e), A.j8(k.FP.NO_BID, e));
                            }),
                            i && 0 === r && e();
                        }
                        return {
              ...
              return (
                A.on(k.FP.SEAT_NON_BID, function (e) {
                  var n;
                  e.auctionId === C && ((n = e.seatnonbid), ($ = $.concat(n)));
                }),
                {
                  ...
                  callBids: function () {
                    (p = "started"), (l = Date.now());
                    var e = d.measureTime(
                      "requestBids.makeRequests",
                      function () {
                        return T.ZP.makeBidRequests(h, l, C, j, y, s, d);
                      }
                    );
                    (0, o.PN)(
                      ...
                      e.length < 1
                        ? ((0, o.yN)(
                          ...
                          ne())
                        : N.call({ dispatch: re, context: this }, e);
                  },
              ...
              !(function (e) {
                ...
                e.bidderCode &&
                  ...
                  (n = (function (e, n) {
                    ...
                    X(o, a, n, i),
                      e &&
                        C.S.getOwn(e, k.k2.xn) &&
                        (X(o, C.S.ownSettingsFor(e), n, i),
                ...
                (0, E.Bf)(n.metrics).timeSince(
                  "addBidResponse",
                  "addBidResponse.total"
                ),
                e.addBidReceived(n),
                A.j8(k.FP.BID_RESPONSE, n);
            }
            function H(e, n, t) {
              var r =
                  arguments.length > 3 && void 0 !== arguments[3]
            ...
            var M,
              ...
              W = function (e) {
                var n,
                  t,
                  r =
                    null === (n = ue.index.getAdUnit(e)) || void 0 === n
                      ? void 0
                      : n.nativeOrtbRequest,
                ...
                (r[k.k2.xn] ||
                  (r[k.k2.xn] = (function () {
                    ...
                    return [
                      ...
                      $(e.DSP, function (e) {
                        return e.meta &&
                          (e.meta.networkId || e.meta.networkName)
            ...
            function X(e, n, t, r) {
              ...
              return (
                ...
                (i || []).forEach(function (i) {
                  ...
                  if (
                    (e[a] &&
                      (0, o.yN)("The key: " + a + " is being overwritten"),
                    (0, o.LQ)(u))
                  )
                    try {
                      u = u(t, r);
                      ...
                      : n.end.then(function () {
                          return (
                            ...
                            Math.max.apply(
                              Math,
                              [e].concat(
                                (0, i.Z)(n.getBidsReceived().map(re.N))
                              )
                            )
                          );
                        });
              ...
              return (
                (0, i.Z)(e, [
                  ...
                  },
                  {
                    ...
                    value: function () {
                      var e = this;
                      return Object.keys(this.getSettings()).filter(function (
                        n
                      ) {
            ...
            var b = (function () {
              ...
              function B(e, n) {
                var t =
                  ...
                  i = n;
                if (
                  ("string" != typeof e && ((i = e), (e = y), (t = n || {})),
                  "function" == typeof i)
                ) {
                  var o = { topic: e, callback: i };
                  return (
                    d.push(o),
                    t.init && i(e === y ? T() : (0, r.Z)({}, e, T(e))),
                    function () {
              ...
              B = (function () {
                function e() {
                  ...
                  (0, d.Z)(this, e),
                    ...
                    m(this, k, { writable: !0, value: void 0 }),
                    m(this, O, { writable: !0, value: void 0 }),
                    m(this, E, { writable: !0, value: !0 }),
                    ...
                    },
                    {
                      ...
                      get: function () {
                        return (0, g.Z)(this, O)
                          ...
                          : ((0, g.Z)(this, A) ||
                              C(this, I, S).call(this, null),
                            (0, g.Z)(this, k).promise);
                      },
                    },
                    {
                      key: "setConsentData",
                      ...
                      value: function () {
                        ...
                        if (e && e.vendorData && this.generatedTime)
                          return {
                            ...
                            consentStringSize: (0, p.d8)(e.vendorData.tcString)
              ...
              M =
                ...
                (Z = {}),
                {
                  ...
                  get: function (e) {
                    var n = { modules: x[e] || {} };
                    return (
                      D.hasOwnProperty(e) && D[e] !== Z && (n.gvlid = D[e]), n
                    );
                  },
                }),
              F = { gdpr: N, usp: q, gpp: _, coppa: H };
            var W = (function () {
              var e =
                arguments.length > 0 && void 0 !== arguments[0]
                  ? arguments[0]
          ...
          2021: function (e, n, t) {
            ...
            a.vc.getConfig(u, function (e) {
              ...
              (e = null === (n = e) || void 0 === n ? void 0 : n[u]),
                t !== (c = "number" == typeof e ? 1e3 * e : null) &&
                  s.refresh();
            });
          ...
          59: function (e, n, t) {
                ...
                : n.every(function (e) {
                    return (function (e) {
                      ...
                      if (e.img) {
                        ...
                        return (
                          (0, u.H)("video asset is not properly configured"), !1
                        );
                      return !0;
                    })(e);
                  });
            ...
            function R(e, n) {
              var t = n.native.ortb || H(n.native);
              return (
                "click" === e.action
                  ? (function (e) {
                      var n =
            ...
            function P(e) {
              ...
              (0, a.Z)(o, "nativeParams.rendererUrl")
                ? (e.native.rendererUrl = q(o.nativeParams.rendererUrl))
                : (0, a.Z)(o, "nativeParams.adTemplate") &&
                  (e.native.adTemplate = q(o.nativeParams.adTemplate));
              ...
              return (
                ...
                Object.keys(d).forEach(function (n) {
                  var t = c[n],
                    r =
                      q(e.native[n]) || q((0, a.Z)(e, "native.ext.".concat(n)));
                  if ("adTemplate" !== n && t && r) {
              ...
              return (
                n.native.ortb
                  ...
                  : null !== (r = f.mediaTypes) &&
                    ...
                    void 0 !== i &&
                    i.ortb &&
                    (c.ortb = M(n.native, f.nativeOrtbRequest)),
                (c.assets = []),
                (null == t ? Object.keys(l) : t).forEach(function (e) {
                  if ("adTemplate" === e && l[e]) c.adTemplate = q(l[e]);
                  else if ("rendererUrl" === e && l[e]) c.rendererUrl = q(l[e]);
                  else if ("ext" === e)
                    ...
                    switch (n) {
                      ...
                      default:
                        n in w &&
                          r(
                            function (e) {
                              return null != e.data && e.data.type === b[w[n]];
                            },
                            function (e) {
                              e.data = { value: t };
                            }
              ...
              try {
                var u = function () {
                  ...
                  e.title
                    ...
                    : e.img
                    ? (t[n.img.type === m.MAIN ? "image" : "icon"] = {
                        url: e.img.url,
                        width: e.img.w,
                        height: e.img.h,
                      })
                    : e.data && (t[T[k[n.data.type]]] = e.data.value);
                };
              ...
              try {
                for (l.s(); !(d = l.n()).done; ) {
                  ...
                  g.event === E &&
                    ...
                    g.event === E && g.method === O.js && s.push(g.url);
                }
              } catch (e) {
                l.e(e);
              } finally {
          ...
          2521: function (e, n, t) {
                ...
                (0, i.Z)(s, h.G, function (e, n, t) {
                  ...
                  switch (n.event) {
                    case l.FP.AD_RENDER_FAILED:
                      (0,
                      p.Pm)({ bid: t, id: n.adId, reason: n.info.reason, message: n.info.message });
                      break;
                    case l.FP.AD_RENDER_SUCCEEDED:
                      (0, p.bL)({ doc: null, bid: t, id: n.adId });
                      break;
                    default:
                      (0,
                      a.H)("Received x-origin event request for unsupported event: '".concat(n.event, "' (adId: '").concat(n.adId, "')"));
                  }
                }),
                s);
            function w(e) {
            ...
            Object.assign(
              ...
              (0, i.Z)({}, h.u7, function (e, n, t) {
                ...
                b.has(t) || (b.add(t), g.K.addWinningBid(t), d.j8(y, t));
                switch (n.action) {
                  case "assetRequest":
                    e((0, f.eK)(n, t));
                    break;
            ...
            var x = B(function (e) {
              ...
              z = {
                ...
                isBidNotExpired: function (e) {
                  return e.responseTimestamp + 1e3 * (0, q.N)(e) > (0, a.AB)();
                },
                isUnusedBid: function (e) {
                  return (
                    e &&
                    ((e.status && !(0, v.q9)([l.UE.fe], e.status)) || !e.status)
                  );
                },
              };
            function L(e) {
              return !Object.values(z).some(function (n) {
                return !n(e);
              });
            }
            var K = (0, E.z3)("sync", function (e, n) {
              var t =
                  arguments.length > 2 && void 0 !== arguments[2]
                    ? arguments[2]
                    : 0,
                    ...
                    Object.keys(c).forEach(function (e) {
                      ...
                      t > 0
                        ? ((r = o
                          ...
                          i.push.apply(i, (0, k.Z)(r.slice(0, t))))
                        : i.push.apply(i, (0, k.Z)(r));
                  }),
                  i
                );
              }
            ...
            var J = (function (e) {
                ...
                function r(e, n) {
                  return (
                    e.adserverTargeting &&
                    n &&
                    (((0, a.kJ)(n) && (0, v.q9)(n, e.adUnitCode)) ||
                ...
                function o(e, n) {
                  if (
                    !0 ===
                    T.vc.getConfig("targetingControls.alwaysIncludeDeals")
                  ) {
                    var t = W.concat(f.xc);
                    return K(n, Z)
                      .map(function (n) {
                          ...
                          .reduce(function (n, t) {
                            ...
                            if (t === l.TD.DEAL) {
                              var a = ""
                                  ...
                                  .substring(0, 20),
                                u = (0, i.Z)({}, a, r);
                              return [].concat((0, k.Z)(n), [o, u]);
                            }
                            return [].concat((0, k.Z)(n), [o]);
                          }, [])
                      );
                    })),
                    r
                    ...
                    if ((0, a.T9)()) {
                      var r = g(n),
                        i = e.getAdUnits().filter(function (e) {
                          return (0, v.q9)(r, e.code);
                        }),
                        o = _.reduce(function (e, n) {
                          return (e[n] = null), e;
                        }, {});
                      window.googletag
                        .pubads()
                  ...
                  (n.getAllTargeting = function (e) {
                    var n =
                      ...
                      r = h(t, n)
                        .concat(C(t, n))
                        .concat(
                          T.vc.getConfig("enableSendAllBids")
                            ? A(t, n)
                            : o(t, n)
                        )
                        .concat(I(t));
                    r.map(function (e) {
                      Object.keys(e).map(function (n) {
                        e[n].map(function (e) {
                          -1 === _.indexOf(Object.keys(e)[0]) &&
                            (_ = Object.keys(e).concat(_));
                        });
                      });
                    });
            ...
            var te = (function () {
              var e =
                ...
                t = void 0 === n ? ne() : n,
                r = e.hook,
                i = void 0 === r ? (0, E.v5)("requestBids") : r,
                o = null,
                a = !1;
              function u(e) {
                for (
                  ...
                  r[i - 1] = arguments[i];
                return (o || $.Z.resolve()).then(function () {
                  return e.apply(n, r);
                });
              }
              function c() {
                  ...
                  if (!t.hasOwnProperty(o))
                    try {
                      t[o] = n
                        ...
                        .then(function (e) {
                          return (0, a.xb)(e) ? null : Object.freeze(ve(2, e));
                        })
                        .catch(function () {
                          return null;
                        });
            ...
            function ve(e, n) {
              ...
              return (
                ...
                (n.fullVersionList || n.brands) &&
                  (r.browsers = (n.fullVersionList || n.brands).map(function (
                    e
                  ) {
            ...
            var Te,
              ...
              Ee = (0, E.z3)("sync", function (e) {
                var n,
                  t = [
                    e,
                    ((n = T.vc.getConfig("firstPartyData.uaHints")),
                    Array.isArray(n) && 0 !== n.length
                      ? ke.getHighEntropySUA(n)
                      : $.Z.resolve(ke.getLowEntropySUA())).catch(function () {
                      return null;
                    }),
                    $.Z.resolve(
                      "cookieDeprecationLabel" in navigator &&
                        (0, ye.xD)(me.S1, (0, be.T)(we.wu, "cdep")) &&
                        navigator.cookieDeprecationLabel.getValue()
                    ).catch(function () {
                      return null;
                    }),
                  ];
                return $.Z.all(t).then(function (e) {
                  var n = (0, r.Z)(e, 3),
                    t = n[0],
                    i = n[1],
                    o = n[2],
            ...
            function je(e) {
              try {
                return e(ke.getWindowTop());
              } catch (n) {
                return e(ke.getWindowSelf());
              }
            }
            function Ie(e) {
            ...
            var Be = {
              site: function (e, n) {
                if (
                  ...
                  return Ie({ page: n.page, ref: n.ref });
              },
              device: function () {
              ...
              return Ie({
                ...
                keywords:
                  ...
                  void 0 === i
                    ? void 0
                    : i.call(r, /\s/g, ""),
                publisher: Ie({ domain: ke.findRootDomain(o) }),
              });
            }
            var Ue = t(2513),
              Re = t(9819),
            ...
            !(function () {
              ...
              (xe.bidderSettings = xe.bidderSettings || {}),
              (xe.libLoaded = !0),
              (xe.version = "v8.32.0-pre"),
              (0, a.PN)("Prebid.js v8.32.0-pre loaded"),
              (xe.installedModules = xe.installedModules || []),
              (xe.adUnits = xe.adUnits || []),
              (xe.triggerUserSyncs = De);
            var Ge = {
              validateAdUnit: Ke,
              validateBannerMediaType: Fe,
              validateSizes: Me,
            };
            Object.assign(Ge, { validateNativeMediaType: ze }),
              Object.assign(Ge, { validateVideoMediaType: We });
            var Je,
              Ve = (0, E.z3)(
                "sync",
                function (e) {
            ...
            (xe.getAdserverTargetingForAdUnitCodeStr = function (e) {
              if (
                ((0, a.PN)(
                ...
                var n = xe.getAdserverTargetingForAdUnitCode(e);
                return (0, a.Ob)(n);
              }
              (0, a.ji)(
              ...
              (xe.getHighestUnusedBidResponseForAdUnitCode = function (e) {
                if (e) {
                  var n = g.K.getAllBidsForAdUnitCode(e).filter(L);
              ...
              (xe.getAdserverTargetingForAdUnitCode = function (e) {
                return xe.getAdserverTargeting(e)[e];
              }),
              (xe.getAdserverTargeting = function (e) {
                return (
                  (0, a.PN)("Invoking pbjs.getAdserverTargeting", arguments),
                  J.getAllTargeting(e)
                );
              }),
              (xe.getConsentMetadata = function () {
                return (
                  (0, a.PN)("Invoking pbjs.getConsentMetadata"),
                  Ue.NO.getConsentMeta()
                );
              }),
              (xe.getNoBids = function () {
                return (
                  (0, a.PN)("Invoking pbjs.getNoBids", arguments),
                  $e("getNoBids")
                );
              }),
              (xe.getNoBidsForAdUnitCode = function (e) {
                return {
              ...
              (xe.getBidResponses = function () {
                return (
                  (0, a.PN)("Invoking pbjs.getBidResponses", arguments),
                  $e("getBidsReceived")
                );
              }),
              (xe.getBidResponsesForAdUnitCode = function (e) {
                return {
              ...
              (xe.setTargetingForGPTAsync = function (e, n) {
                if (
                  ((0, a.PN)(
                  ...
                  J.resetPresetTargeting(e, n),
                    ...
                    Object.keys(t).forEach(function (e) {
                      Object.keys(t[e]).forEach(function (n) {
                        "hb_adid" === n &&
                          g.K.setStatusForBids(t[e][n], l.UE.CK);
                      });
                    }),
                    d.j8(_e, t);
                } else (0, a.H)("window.googletag is not defined on the page");
              }),
              (xe.setTargetingForAst = function (e) {
              ...
              (xe.renderAd = (0, E.z3)("async", function (e, n, t) {
                (0, a.PN)("Invoking pbjs.renderAd", arguments),
                  (0, a.ji)("Calling renderAd with adId :" + n),
                  (0, Re.t)(e, n, t);
              })),
              (xe.removeAdUnit = function (e) {
                ((0, a.PN)("Invoking pbjs.removeAdUnit", arguments), e)
                  ? ((0, a.kJ)(e) ? e : [e]).forEach(function (e) {
                      for (var n = xe.adUnits.length - 1; n >= 0; n--)
                        xe.adUnits[n].code === e && xe.adUnits.splice(n, 1);
                    })
                  : (xe.adUnits = []);
              }),
              (xe.requestBids =
                ((Je = (0, E.z3)(
                  ...
                  function () {
                    var e =
                      ...
                      g = e.defer;
                    d.j8(qe);
                    var p = t || T.vc.getConfig("bidderTimeout");
                    ...
                    return Ee($.Z.resolve(h.global)).then(function (e) {
                      return (
                        (h.global = e),
                        Ye({
                          bidsBackHandler: n,
            ...
            var Ye = (0, E.z3)(
              ...
              function () {
                var e =
                  ...
                  f = e.metrics,
                  l = e.defer,
                  p = (0, oe.uV)(T.vc.getConfig("s2sConfig") || []);
                function h(e, t, r) {
                  if ("function" == typeof n)
                    try {
                      n(e, t, r);
                ...
                if (
                  ...
                  b > 15 &&
                    (0, a.PN)(
                      "Current auction "
                        .concat(y.getAuctionId(), " contains ")
                        .concat(b, " adUnits."),
                      r
                    ),
                    o.forEach(function (e) {
                      return J.setLatestAuctionForAdUnit(e, y.getAuctionId());
                    }),
                    y.callBids();
                } else
            ...
            xe.requestBids.before(function (e, n) {
              function t(e) {
                for (var n; (n = e.shift()); ) n();
              }
              t(ie.Ld), t(Xe), e.call(this, n);
            }, 49),
              (xe.addAdUnits = function (e) {
                (0, a.PN)("Invoking pbjs.addAdUnits", arguments),
                  xe.adUnits.push.apply(xe.adUnits, (0, a.kJ)(e) ? e : [e]),
                  d.j8(Ne);
              }),
              (xe.onEvent = function (e, n, t) {
              ...
              (xe.offEvent = function (e, n, t) {
                (0, a.PN)("Invoking pbjs.offEvent", arguments),
                  (t && !He[e].call(null, t)) || d.S1(e, n, t);
              }),
              (xe.getEvents = function () {
                return (0, a.PN)("Invoking pbjs.getEvents"), d.vw();
              }),
              (xe.registerBidAdapter = function (e, n) {
              ...
              (xe.registerAnalyticsAdapter = function (e) {
            ...
            (xe.enableAnalytics = function (e) {
              Xe.push(en.bind(this, e));
            }),
              (xe.aliasBidder = function (e, n, t) {
              ...
              (xe.aliasRegistry = oe.ZP.aliasRegistry),
              T.vc.getConfig("aliasRegistry", function (e) {
                "private" === e.aliasRegistry && delete xe.aliasRegistry;
              }),
              (xe.getAllWinningBids = function () {
                return g.K.getAllWinningBids();
              }),
              (xe.getAllPrebidWinningBids = function () {
                return g.K.getBidsReceived().filter(function (e) {
                  return e.status === l.UE.CK;
                });
              }),
              (xe.getHighestCpmBids = function (e) {
                return J.getWinningBids(e);
              }),
              (xe.markWinningBidAsUsed = function (e) {
                var n = nn(
                  e,
            ...
            (xe.getConfig = T.vc.getAnyConfig),
              (xe.readConfig = T.vc.readAnyConfig),
              (xe.mergeConfig = T.vc.mergeConfig),
              (xe.mergeBidderConfig = T.vc.mergeBidderConfig),
              (xe.setConfig = T.vc.setConfig),
              (xe.setBidderConfig = T.vc.setBidderConfig),
              xe.que.push(function () {
                window.addEventListener("message", w, !1);
              }),
              (xe.cmd.push = function (e) {
              ...
              (xe.que.push = xe.cmd.push),
              (xe.processQueue = function () {
                E.z3.ready(), tn(xe.que), tn(xe.cmd);
              }),
              (xe.triggerBilling = function (e) {
                var n = nn(
                    e,
              ...
              s = (function (e) {
                ...
                function () {
                  ...
                  var E = g || y ? n : null,
                    ...
                    I = r.vc.getConfig("pageUrl") || E || o(j, c);
                  return (
                    E &&
                      E.indexOf("?") > -1 &&
                      -1 === I.indexOf("?") &&
                      (I = "".concat(I).concat(E.substring(E.indexOf("?")))),
                    {
                      reachedTop: g,
                      isAmp: p,
                      numIframes: v - 1,
            ...
            function h() {
              ...
              function b(e, i) {
                ...
                return (
                  ...
                  e({ valid: y(s.S1, (0, l.T)(t, o, (0, r.Z)({}, c.bL, i))) })
                );
              }
              function m(e, n, t) {
              ...
              var w = function (e, n, t, r, i, o) {
                ...
                k = function (e, n, t) {
                  return m(
                    function (t) {
                      t && t.valid && j() && window.localStorage.setItem(e, n);
                    },
                    g,
                    t
                  );
                ...
                E = function (e, n) {
                  return m(
                    function (n) {
                      n && n.valid && j() && window.localStorage.removeItem(e);
                    },
                    g,
                    n
                  );
              ...
              return {
                ...
                cookiesAreEnabled: T,
                setDataInLocalStorage: k,
                getDataFromLocalStorage: O,
              ...
              Object.defineProperties(
                ...
                },
                {
                  browserSupportsCookies: {
                    get: function () {
                      return !(0, o.fr)() && v.cookiesAreEnabled();
                    },
                  },
                }
              )
          ...
          4358: function (e, n, t) {
            ...
            var r,
              ...
              y = Boolean(h && window.console.log),
              b = Boolean(h && window.console.info),
              m = Boolean(h && window.console.warn),
            ...
            function N() {
              W() && y && console.log.apply(console, F(arguments, "MESSAGE:"));
            }
            function q() {
              W() && b && console.info.apply(console, F(arguments, "INFO:"));
            }
            function _() {
              W() && m && console.warn.apply(console, F(arguments, "WARNING:")),
                T(l.FP.AUCTION_DEBUG, {
                  type: "WARNING",
                  arguments: arguments,
                });
            }
            function H() {
              W() && w && console.error.apply(console, F(arguments, "ERROR:")),
                T(l.FP.AUCTION_DEBUG, { type: "ERROR", arguments: arguments });
            }
            function M(e) {
              function n(n) {
                return function () {
            ...
            function z(e) {
              return Re(Z().search)[e] || "";
            }
            function L(e, n) {
              return p.call(e) === "[object " + n + "]";
            }
            function K(e) {
              return L(e, "Function");
            }
            ...
            var J = Array.isArray.bind(Array);
            function V(e) {
              return L(e, "Number");
            }
            function Q(e) {
            ...
            function Y(e) {
              return (
                !e ||
                (J(e) || G(e) ? !(e.length > 0) : Object.keys(e).length <= 0)
              );
            }
            function X(e) {
            ...
            function te(e, n, t) {
              var r = new Image();
              n && k.isFn(n) && ne(r, t).then(n), (r.src = e);
            }
            function re(e) {
              var n = e.source,
                t = e.burl;
              n === l.os.YZ && t && k.triggerPixel(t);
            }
            function ie(e) {
              if (e) {
                var n,
                  t,
                  r =
                    (((n = document.createElement("iframe")).id = j()),
                    (n.height = 0),
                    (n.width = 0),
                    (n.border = "0px"),
                    (n.hspace = "0"),
                    ...
                    n);
                k.insertElement(r, document, "body"),
            ...
            function oe(e, n, t) {
              var r = k.createTrackPixelIframeHtml(
                  e,
                  !1,
            ...
            var Be = Number.isInteger.bind(Number);
            function Se(e, n) {
            ...
            function Pe(e, n) {
              ...
              return {
                ...
                search: r ? t.search : k.parseQS(t.search || ""),
                hash: (t.hash || "").replace(/^#/, ""),
            ...
            function De(e, n) {
              ...
              for (var o in e) {
                ...
                if (!De(e[o], n[o], { checkTypes: i })) return !1;
              }
              return !0;
            }
            function Ze(e) {
              ...
              return Ze.apply(void 0, [e].concat(t));
            }
            function Ne(e) {
              for (
                var n,
                  t =
                    arguments.length > 1 && void 0 !== arguments[1]
                      ...
                      : 0,
                  r = function (e, n) {
                    if (K(Math.imul)) return Math.imul(e, n);
                    var t = (4194303 & e) * (n |= 0);
                    return (
          ...
          9128: function (e, n, t) {
            ...
            m("requestBids.", function (e) {
              return e.metrics;
            }),
              m("addBidResponse.", function (e, n) {
                return n.metrics;
              });
          },
          8792: function (e, n, t) {
            ...
            function s() {
              ...
              function C(e) {
                var r,
                  a = {},
                  u = A;
                var c = Object.entries({ start: d, delta: l }).map(function (
                    c
                  ) {
                    var s,
                      d = (0, i.Z)(c, 2),
            ...
            function a(e) {
              ...
              function v(n, r, c) {
                ...
                var f,
                  ...
                  h = {
                    get: function (e, n) {
                      return p[n] || Reflect.get.apply(Reflect, arguments);
                    },
                  };
                return (
                  u || s.push(y),
                  e.useProxy && "function" == typeof Proxy && Proxy.revocable
                    ...
                    : ((v = function () {
                      ...
                      o(v, p)),
                  t.get(v.after).install(n, v, function (e, t) {
                    var r,
                      o = [];
                    e.length || t.length
                      ? (e.forEach(a),
            ...
            try {
              if (n && e) {
                var l = (r = u.K.findBidByAdId(n)) && u.K.index.getAdUnit(r),
                  m = (0, f.R)().videoModule;
                if (null != l && l.video && m)
                  return void m.renderBid(l.video.divId, r);
                e !== document || (0, s.yL)()
                  ? (0, i.XD)(
                      function (n) {
                        !(function (e, n) {
      ...
      [861],
      {
        4563: function (e, n, t) {
          ...
          var a = t(3324),
            ...
            u = "endpoint",
            f = "bundle",
            p = Object.values(r.FP).filter(function (e) {
              return e !== r.FP.AUCTION_DEBUG;
            }),
            d = 100;
          function v(e) {
            var n,
              ...
              m =
                ...
                (y = function () {
                  if (!v) {
                    v = !0;
                    try {
                      for (var e = 0, n = 0; j.length > 0; ) {
                        e++;
                        var a = j.length;
                        if (
                          (j.shift()(), j.length >= a ? n++ : (n = 0), n >= 10)
                        )
                          return (
                            (0, o.H)(
            ...
            return Object.defineProperties(
              {
                track: function (e) {
                  var n = e.eventType,
                    t = e.args;
                  this.getAdapterType() === f && window[g](T, n, t);
                  this.getAdapterType() === u && E.apply(void 0, arguments);
                },
                enqueue: O,
                enableAnalytics: k,
            ...
            function E(e) {
              var n = e.eventType,
                t = e.args,
                a = e.callback;
              s.ajax(b, a, JSON.stringify({ eventType: n, args: t }));
            }
            function O(e) {
              var n = this,
                t = e.eventType,
            ...
            function k(e) {
              ...
              if (
                ...
                (0, o.ji)(
                  'Analytics adapter for "'.concat(g, '" disabled by sampling')
                );
      ...
      [532],
      {
        ...
        console.log('publir module reached')
          var t = n(8640),
            ...
            A = Object.assign(
              (0, s.ZP)({ DEFAULT_SERVER: d, analyticsType: "endpoint" }),
              {
                cachedAuctions: {},
                initConfig: function (i) {
                  return (
                    (v.options = (0, c.I8)(i.options)),
                    "string" != typeof i.options.affiliateId ||
                    i.options.affiliateId.length < 1
                      ? ((0, c.H)('"options.affiliateId" is required.'),
                        console.log("ERROR:options.affiliateId is required."),
                        !1)
                      : "string" != typeof i.options.configId ||
                        i.options.configId.length < 1
                      ? ((0, c.H)('"options.configId" is required.'),
                        console.log("ERROR:options.configId is required."),
                        !1)
                      : ((v.affiliateId = i.options.affiliateId),
                        (v.configId = i.options.configId),
                        (v.server = i.options.server || d),
                        (v.sampled = !0),
                        ...
                        (v.autoPick = i.options.autoPick || null),
                        (v.predictionId = i.options.predictionId || null),
                        !0)
                  );
                },
                sendEventMessage: function (i, e) {
                  (0, c.PN)("AJAX: ".concat(i, ": ") + JSON.stringify(e)),
                    console.log("AJAX: ".concat(i, ": ") + JSON.stringify(e)),
                    (0, o.hj)(
                      "".concat(v.server, "/").concat(i),
                      null,
                      JSON.stringify(e),
                ...
                serializeBidResponse: function (i, e) {
                  var n = { prebidWon: e === m, isTimeout: e === I, status: e };
                  return (
                    (e !== g && e !== m) ||
                      Object.assign(n, {
                ...
                createBidMessage: function (i, e, n) {
                  var t = this,
                    o = i.auctionId,
                    s = i.timestamp,
                    a = i.timeout,
                  ...
                  return (
                    ...
                    n.forEach(function (i) {
                      return t.addBidResponseToMessage(p, i, I);
                    }),
                ...
                createImpressionMessage: function (i) {
                  var e = this.createCommonMessage(i.auctionId);
                  return this.addBidResponseToMessage(e, i, m), e;
                },
                createCreativeMessage: function (i, e) {
                  var n = this.createCommonMessage(i);
                  return (
                    e.forEach(function (i) {
                      var e = C(i),
                        t = y(i);
                ...
                getCachedAuction: function (i) {
                  return (
                    (this.cachedAuctions[i] = this.cachedAuctions[i] || {
                      timeoutBids: [],
                    }),
                    this.cachedAuctions[i]
                  );
                },
                handleAuctionEnd: function (i) {
                  var e = this.getCachedAuction(i.auctionId),
                    n = (0, t.R)().getHighestCpmBids();
                ...
                handleBidTimeout: function (i) {
                  var e = this;
                  i.forEach(function (i) {
                    e.getCachedAuction(i.auctionId).timeoutBids.push(i);
                  });
                },
                handleBidWon: function (i) {
                  this.sendEventMessage("imp", this.createImpressionMessage(i));
                },
                track: function (i) {
                  var e = i.eventType,
                    n = i.args;
                  if (v.sampled)
                    switch (e) {
                      case l:
                        ...
                        break;
                      case f:
                        this.handleBidTimeout(n);
                        break;
                      case p:
                        this.handleAuctionEnd(n);
                    }
                },
          ...
          (A.originEnableAnalytics = A.enableAnalytics),
            (A.enableAnalytics = function (i) {
              this.initConfig(i) && A.originEnableAnalytics(i);
            }),
            r.ZP.registerAnalyticsAdapter({ adapter: A, code: "publir" }),
            (0, t.z)("publirAnalyticsAdapter");
        },
      },
      function (i) {
        i.O(0, [861, 409], function () {
          return (e = 5647), i((i.s = e));
          var e;
        });
        i.O();
      },
